...
Use only the allowed theme slugs supplied with the job. A memorable passage must be
copied verbatim from `story_text`. Mark a story ineligible when it is a duplicate,
